...
namespace Lokad.Cqrs.AtomicStorage
{
	...
	public interface IDocumentWriter< in TKey, TEntity >
	{
		...
		Task< TEntity > AddOrUpdateAsync( TKey key, Func< TEntity > addFactory, Func< TEntity, TEntity > update, AddOrUpdateHint hint = AddOrUpdateHint.ProbablyExists );
		Task SaveAsync( TKey key, TEntity entity );
