...
namespace Lokad.Cqrs
{
	...
	public static class AzureStorage
	{
			...
			TimeSpan visibilityTimeout = default( TimeSpan ) )
		{
			...
			var container = cfg.CreateBlobClient().GetContainerReference( "queues-big" );
			var directory = container.GetDirectoryReference( name );
			...
			var reader = new StatelessAzureQueueReader( name, queue, new AzureBlobDirectory( container, directory ), poisonQueue, timeout );
			reader.InitIfNeeded();
			return reader;
		}
